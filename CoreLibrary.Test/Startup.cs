...
using HttpContextConfig = CoreLibrary.AutoFac.HttpContextConfig;
...
namespace CoreLibrary.Test
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            var authConnection = Configuration["Data:DefaultConnection"];
            var appicationConnection = Configuration["Data:CoreLibraryConnection"];
            services.AddIdentityDbContext<ApplicationDbContext>(authConnection);
            services.AddDbContext<ProjectmeetingContext>(options =>
                options.UseSqlServer(appicationConnection));
            ...
            , IServiceProvider svp)
        {
            ...
            HttpContextConfig.ServiceProvider = app.ApplicationServices;
