...
namespace CoreLibrary.BusinessLogic.Service
{
    public interface IMeetingService
    {
        ...
        CountModel<MeetingModel> GetCount(int page, int count, MeetingFilter filter, string orderByExpression = null);
    ...
    public class MeetingService : IMeetingService
    {
        ...
        public CountModel<MeetingModel> GetCount(int page, int count, MeetingFilter filter, string orderByExpression = null)
        {
            throw new NotImplementedException();
        }
